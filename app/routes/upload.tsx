...
const upload = () => {
    ...
    const handleAnalyze = async({companyName, jobTitle, jobDescription, file}:
        {companyName:string,jobTitle:string,jobDescription:string,file:File  })=>{
            ...
            if(!imageFile.file){return setStatusText("failed convert pdf to image")}
                ...
                {!isProcessing && (
                    <form id="upload-form" className="flex flex-col gap-4 mt-8" onSubmit={handleSubmit}>
                        ...
                        <div className="form-div">
                            ...
                            <FileUploader onFileSelect={handleFileSelect} name="uploader"/>
                        </div>
